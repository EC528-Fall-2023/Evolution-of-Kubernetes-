...
The kubernetes SBOMS are structured so that it returns images, binaries, and tar.gz files. For this project we focused on the container images to find retreive the vulnerabilites which was accomplsiehd by utilzing Syft and Grype. 
